...
# 25 "wc209.c"
 ...
 else if(c=='/') nLetr++, state=2;
 else nLetr++, nWord++, state=1;
}
...
# 39 "wc209.c"
 ...
 else if(c=='*') err_line=nLine, state=4;
 else if(c=='/') nLetr++, nWord++, state=3;
 else nLetr++,nWord++, state=1;
}
